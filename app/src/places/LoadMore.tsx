...
const LoadMore: React.FC<LoadMoreProps> = ({ onSelect, index }) => {
  return (
    <div className="h-48 flex items-center justify-center bg-white text-white font-mono font-semibold rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 bg-gradient-to-b from-[#00B4DB] to-[#0083B0]">
